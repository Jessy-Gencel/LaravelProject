...
class AchievementSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Achievement::insert([
            ...
            ['name' => 'Alien Guardrail', 'description' => 'Awarded for reaching a score of 50000.', 'icon_path' => 'badges/alien_guardrail.png', 'color' => '#C3FFA3', 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'Alien Bastion', 'description' => 'Awarded for reaching a score of 100000.', 'icon_path' => 'badges/alien_bastion.png', 'color' => '#FFB3B3', 'created_at' => now(), 'updated_at' => now()],
